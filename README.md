...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a
href="#download" class="nav-link">Реклама</a></li>
    ...
    <div class="container">
        ...
        <div id="home" class="section active">
            ...
            <p>Здесь вы найдете всю необходимую информацию о нашем проекте.</p>
            
            <h2>Что мы делаем?</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            
            <h2>Наши преимущества</h2>
            <p>✅ Качественный продукт<br>
               ✅ Быстрая работа<br>
               ✅ Отличная поддержка</p>
        </div>

        <!-- О нас -->
        <div id="about" class="section">
            <h1>ℹ️ О нас</h1>
            <p>Мы — команда профессионалов, которая создает крутые проекты.</p>
        ...
        <div id="download" class="section download-section">
            <h1>📢 Скачать app-ads.txt</h1>
            <p>Скачайте app-ads.txt!</p>
            
            <button id="downloadBtn" class="download-btn">
                ⬇️ Скачать файл app-ads.txt
            </button>
    ...
    <script>
        ...
        // === СКАЧИВАНИЕ ФАЙЛА ===
        const fileContent = `
yandex.com, 317355943, DIRECT
yango-ads.com, 317355943, DIRECT
...
smaato.com, 1100058938, RESELLER, 07bcf65f187117b4
        ...
        document.getElementById('downloadBtn').onclick = function() {
            ...
            a.href = url;
            a.download = 'app-ads.txt'; // Имя файла
            a.click();
URL.revokeObjectURL(url);
            
            alert('✅ Файл скачан! Проверьте папку "Загрузки"');
        };
    </script>
</body>
</html>
